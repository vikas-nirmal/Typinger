...
export const Lvl6 = () => {
    ...
    const arr2 = ['g','g','g','g',' ','h','h','h','h',' ','g','g',' ','h','h',' ','g','g','g',' ','h','h','h',' ','g','h',' ','g','h',' ','h','h','g',' ','g','g','h',' ','g','g','g',' ','h','h','h',' ','g','g','h',' ','h','h','g',' ','g','h',,'g','h',' ','g','g','g','h',' ','h','h','h','g',' ','g','g','h','h',' ','g','g',' ','h','h',' ','g','g','g','g']
    var i=0;
    var result;
    ...
    return (
        ...
        <br></br>
        <br></br>
        <a className='next-lvl' href='/Lvl7'>Next</a>
        </>
    )
}
