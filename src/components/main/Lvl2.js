...
export const Lvl2 = () => {
    ...
    const arr2 = ['f','f','f','f',' ','j','j','j','j',' ','f','f',' ','j','j',' ','f','f','f',' ','j','j','j',' ','f','j',' ','f','j',' ','j','j','f',' ','f','f','j',' ','f','f','f',' ','j','j','j',' ','f','f','j',' ','j','j','f',' ','f','j','f','j',' ','f','f','f','j',' ','j','j','j','f',' ','f','f','j','j',' ','f','f',' ','j','j',' ','f','f','f','f']
    var i=0;
    var result;
    ...
    return (
        <>
        <h3 className='heading-fj'>Keep your hand only on home row & use your index finger</h3>
        ...
        <br></br>
        <br></br>
        <a className='next-lvl' href='/Lvl3'>Next</a>
        </>
    )
}
