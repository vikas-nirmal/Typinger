...
export const Lvl14 = () => {
    ...
    const arr2 = ['b','b','b','b',' ','n','n','n','n',' ','b','b',' ','n','n',' ','b','b','b',' ','n','n','n',' ','b','n',' ','b','n',' ','n','n','b',' ','b','b','n',' ','b','b','b',' ','n','n','n',' ','b','b','n',' ','n','n','b',' ','b','n',,'b','n',' ','b','b','b','n',' ','n','n','n','b',' ','b','b','n','n',' ','b','b',' ','n','n',' ','b','b','b','b']
    var i=0;
    var result;
    ...
    return (
        ...
        <br></br>
        <br></br>
        <a className='next-lvl' href='/'>Home</a>
        </>
    )
}
