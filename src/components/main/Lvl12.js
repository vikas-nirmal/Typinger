...
export const Lvl12 = () => {
    ...
    const arr2 = ['v','v','v','v',' ','m','m','m','m',' ','v','v',' ','m','m',' ','v','v','v',' ','m','m','m',' ','v','m',' ','v','m',' ','m','m','v',' ','v','v','m',' ','v','v','v',' ','m','m','m',' ','v','v','m',' ','m','m','v',' ','v','m',,'v','m',' ','v','v','v','m',' ','m','m','m','v',' ','v','v','m','m',' ','v','v',' ','m','m',' ','v','v','v','v']
    var i=0;
    var result;
    ...
    return (
        ...
        <br></br>
        <br></br>
        <a className='next-lvl' href='/Lvl13'>Next</a>
        </>
    )
}
