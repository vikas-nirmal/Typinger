...
export const Lvl4 = () => {
    ...
    const arr2 = ['s','s','s','s',' ','l','l','l','l',' ','s','s',' ','l','l',' ','s','s','s',' ','l','l','l',' ','s','l',' ','s','l',' ','l','l','s',' ','s','s','l',' ','s','s','s',' ','l','l','l',' ','s','s','l',' ','l','l','s',' ','s','l','s','l',' ','s','s','s','l',' ','l','l','l','s',' ','s','s','l','l',' ','s','s',' ','l','l',' ','s','s','s','s']
    var i=0;
    var result;
    ...
    return (
        ...
        <br></br>
        <br></br>
        <a className='next-lvl' href='/Lvl5'>Next</a>
        </>
    )
}
