...
export const Lvl8 = () => {
    ...
    const arr2 = ['e','e','e','e',' ','i','i','i','i',' ','e','e',' ','i','i',' ','e','e','e',' ','i','i','i',' ','e','i',' ','e','i',' ','i','i','e',' ','e','e','i',' ','e','e','e',' ','i','i','i',' ','e','e','i',' ','i','i','e',' ','e','i','e','i',' ','e','e','e','i',' ','i','i','i','e',' ','e','e','i','i',' ','e','e',' ','i','i',' ','e','e','e','e']
    var i=0;
    var result;
    ...
    return (
        ...
        <br></br>
        <br></br>
        <a className='next-lvl' href='/Lvl9'>Next</a>
        </>
    )
}
