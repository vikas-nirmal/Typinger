...
export const Lvl7 = () => {
    ...
    const arr2 = ['r','r','r','r',' ','u','u','u','u',' ','r','r',' ','u','u',' ','r','r','r',' ','u','u','u',' ','r','u',' ','r','u',' ','u','u','r',' ','r','r','u',' ','r','r','r',' ','u','u','u',' ','r','r','u',' ','u','u','r',' ','r','u',,'r','u',' ','r','r','r','u',' ','u','u','u','r',' ','r','r','u','u',' ','r','r',' ','u','u',' ','r','r','r','r']
    var i=0;
    var result;
    ...
    return (
        ...
        <br></br>
        <br></br>
        <a className='next-lvl' href='/Lvl8'>Next</a>
        </>
    )
}
