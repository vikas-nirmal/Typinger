...
export const Lvl9 = () => {
    ...
    const arr2 = ['w','w','w','w',' ','o','o','o','o',' ','w','w',' ','o','o',' ','w','w','w',' ','o','o','o',' ','w','o',' ','w','o',' ','o','o','w',' ','w','w','o',' ','w','w','w',' ','o','o','o',' ','w','w','o',' ','o','o','w',' ','w','o',,'w','o',' ','w','w','w','o',' ','o','o','o','w',' ','w','w','o','o',' ','w','w',' ','o','o',' ','w','w','w','w']
    var i=0;
    var result;
    ...
    return (
        ...
        <br></br>
        <br></br>
        <a className='next-lvl' href='/Lvl10'>Next</a>
        </>
    )
}
