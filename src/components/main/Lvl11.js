...
export const Lvl11 = () => {
    ...
    const arr2 = ['t','t','t','t',' ','p','p','p','p',' ','t','t',' ','p','p',' ','t','t','t',' ','p','p','p',' ','t','p',' ','t','p',' ','p','p','t',' ','t','t','p',' ','t','t','t',' ','p','p','p',' ','t','t','p',' ','p','p','t',' ','t','p',,'t','p',' ','t','t','t','p',' ','p','p','p','t',' ','t','t','p','p',' ','t','t',' ','p','p',' ','t','t','t','t']
    var i=0;
    var result;
    ...
    return (
        ...
        <br></br>
        <br></br>
        <a className='next-lvl' href='/Lvl12'>Next</a>
        </>
    )
}
